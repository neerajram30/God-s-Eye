...
def casedetails():
    ...
    if file and allowed_file(file.filename):
        ...
        cursor.execute("INSERT INTO newcases (m_name,mobile,date,age,file,location) VALUES (%s,%s,%s,%s,%s,%s)", (m_name,mobile,m_date,age,filename,location,))
        conn.commit()
...
def login():
    ...
    if request.method == 'POST' and 'police_id' in request.form and 'password' in request.form:
        ...
        cursor.execute('SELECT * FROM police WHERE police_id = %s', (police_id,))
...
def register():
    ...
    if request.method == 'POST' and 'police_id' in request.form and 'password' in request.form and 'mobile' in request.form:
        ...
        #     flash('Please fill out the form!')
            ...
            cursor.execute("INSERT INTO police (police_id, p_name, station, post, mobile, password) VALUES (%s,%s,%s,%s,%s,%s)", (police_id, p_name, station, post, mobile,_hashed_password,))
            conn.commit()
